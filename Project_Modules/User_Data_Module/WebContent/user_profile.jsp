<%@page import="backEnd.User_Bean"%>
<%@page import="backEnd.Profile_cls"%>
...
<div class="topnav">
  ...
  <a style="float:right" href="#profile" ><i class="fa fa-user-circle"></i></a>
...
<br>
	<table>
		...
		<tr> 
			<td> User Name: <%=obj_User_Bean.getUser_name() %> </td>
		</tr>
		<tr> 
			<td> Matro Card Number: <%=obj_User_Bean.getMc_number() %> </td>
		</tr>		
	</table>
